...
These templates require features in Quarto 1.2, so you will currently need [pre-release versions of Quarto](https://github.com/quarto-dev/quarto-cli/releases).
